...
<body>
  ...
  <div class="sub-bar">
    <div class="container">
      <span class="cep-info"><i class='bx bx-location-plus' ></i> Informe seu CEP</span>
      <nav>
        <ul class="menu">
  ...
  <main>
    <div class="banner">
      <img class="models-image" src="{{asset('images/modelos-removebg-preview.png')}}" alt="Modelos" />
      ...
      <div class="text-overlay">
        ...
        <div class="buy-box">
          <div class="buy-actions">
            <div class="timer"><i class='bx bx-alarm' ></i> 72h</div>
